...
import 'package:hopewell/common/widgets/base_text_widget.dart';
    ...
    children: [
      Container(
        ...
        child: Row(
          ...
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            reusableText("Lihat berita / video terbaru"),
            GestureDetector(
      ...
      Container(
        ...
        child: Row(
          children: [
            reusableMenuText("All", backgroundColor: AppColors.celadon),
